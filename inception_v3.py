...
model.compile(optimizer=tf.train.AdamOptimizer(), loss='sparse_categorical_crossentropy', metrics=[utils.sparse_top_3_categorical_accuracy])
...
model.compile(optimizer=tf.train.MomentumOptimizer(learning_rate=0.0001, momentum=0.9), loss='sparse_categorical_crossentropy', metrics=[utils.sparse_top_3_categorical_accuracy])
