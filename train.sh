...
python3 utils/get_data.py --data=./dataset --data_src=https://dl.challenge.zalo.ai/landmark/train_val2018.zip
#train
python3 finetune.py --data=./dataset/TrainVal/ --mode=train_then_finetune --net=nasnetmobile --dense_layers=1 --workers=2 \
