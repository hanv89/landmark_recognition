python3 finetune_v2.py --data=./data/TrainValAug/ --mode=train_then_finetune --net=densenet_169 --workers=2 \
                    --train_lr=0.0004 --train_epochs=1 --train_steps_per_epoch=40 \
                    --finetune_lr1=0.0002 --finetune_epochs1=3 --finetune_steps_per_epoch1=1280 \
                    --finetune_lr2=0.0002 --finetune_epochs2=1 --finetune_steps_per_epoch2=1280 \
