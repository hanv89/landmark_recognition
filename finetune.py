...
parser.add_argument('--finetune_lr_decay', default=0.3, type = float, help = 'finetune learning rate decay if val_loss does not decrease')
parser.add_argument('--finetune_decay_patience', default=48, type = int)
parser.add_argument('--finetune_stop_patience', default=1000, type = int)
